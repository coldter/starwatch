...
| Event                        | Behavior                                                                                                                                                                                                                                                                                                  |
| ---------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Repo **unstarred**           | GitHub also removes it from any mirrored lists. Local membership **stays** in `group_members`; group queries join `repos.is_starred = 1` by default. If the repo row is purged 90 days later (02 §5), CASCADE removes memberships; re-starring within the window restores group membership automatically. |
