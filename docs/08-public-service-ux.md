...
- **Empty query**: profile hero + "Recently starred" grid + collections strip + corpus stats (`3,448 repos · 1,203 embedded`). This is the discovery surface, not a blank page.
