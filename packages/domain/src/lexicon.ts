...
export const LEXICON: ReadonlyArray<Concept> = [
  {
    ...
    triggers: ["auth", "authentication", "authorization", "login", "oauth", "oidc", "sso", "iam", "jwt", "session", "permissions"],
    expand: ["authentication", "authorization", "oauth", "oidc", "jwt", "sso", "session", "permissions", "access control", "identity"]
  },
  {
    id: "http-client",
    label: "HTTP clients",
  ...
  },
  {
    ...
    expand: ["background jobs", "job queue", "scheduler", "cron", "durable execution", "task queue", "workflow engine"]
  },
  {
    id: "database",
    label: "Databases",
  ...
  },
  {
    ...
    expand: ["vector database", "embeddings", "semantic search", "similarity", "rag", "nearest neighbor"]
  },
  {
    id: "tui",
    label: "Terminal UIs",
